...
final class SmokeTests: XCTestCase {
    /// 原名：test_SU_M0_SMOKE_MainModule五枚举完整
    func test_SU_M0_SMOKE_MainModuleFiveCasesComplete() { XCTAssertEqual(MainModule.allCases.count, 5) }
    ...
    /// 原名：test_MainModule_键与规范一致
    func test_MainModule_keysMatchSpec() {
    ...
    /// 原名：test_ObservationKind_八类齐全且名称非空
    func test_ObservationKind_eightKindsCompleteWithNonEmptyNames() {
