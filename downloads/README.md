  ...
  "models": [
    {
      ...
      "url": "qwen3-0.6b-int8-v2026.03.25-20260912.zip",  // 相对 baseUrl 或绝对 URL
...
5. **离线优先红线**：下载仅由用户在模型设置页显式触发（或用户开启「自动检查更新」后的前台 Wi-Fi 场景）；**识别会话路径绝不隐式联网**，未安装/未就绪时按既有回落链（平台轨/基线轨）工作。
