...
for f in build_medical_data.sh fetch_drug_data.sh fetch_nmpa.sh fetch_ref_data.sh hk_private_source.sh drugkit_build.sh merge_drug_data.sh parse_hk.awk parse_tw.awk; do
