...
public struct TerminologyStore: Sendable {
    public static let shared = TerminologyStore(entries: [
        ...
        // 四域扩充批次一（2026-09-24，任务 7）：常见疾病/检验术语。
        // 纪律：纯描述、零数字阈值（阈值属 GuidelineSource，FR12.4 分离）、
        // 零诊断/因果/分诊结论（BR-006 措辞负清单）。
        // —— 疾病 ——
        "高血压": "以动脉血压持续升高为特征的常见慢性病，多数情况需长期管理",
        "高脂血症": "血液中胆固醇或甘油三酯等脂类水平偏高的状态",
        "糖尿病": "以血糖长期偏高为特征的代谢性疾病，分不同类型",
        "冠心病": "冠状动脉供血不足引起的心脏疾病总称",
        "脑卒中": "脑血管突然出问题导致的脑损伤，俗称中风，分缺血性与出血性",
        "肺炎": "肺部的炎症，常见病因包括细菌与病毒感染",
        "支气管炎": "支气管的炎症，常表现为咳嗽、咳痰",
        "哮喘": "气道慢性炎症性疾病，可反复出现喘息、气促",
        "贫血": "血液中红细胞或血红蛋白低于正常范围的状态",
        "胃炎": "胃黏膜的炎症，可表现为上腹不适",
        "消化性溃疡": "胃或十二指肠黏膜的溃疡性病变",
        "脂肪肝": "肝细胞内脂肪堆积过多的状态",
        "胆囊结石": "胆囊内形成的结石，可无症状或引起胆绞痛",
        "甲状腺功能亢进": "甲状腺激素分泌过多引起的状态，简称甲亢",
        "甲状腺功能减退": "甲状腺激素分泌不足引起的状态，简称甲减",
        "骨质疏松": "骨量减少、骨结构变脆，骨折风险升高的状态",
        "类风湿关节炎": "以关节慢性炎症为特点的自身免疫性疾病",
        "痛风": "尿酸代谢异常导致尿酸盐在关节等处沉积引起的疾病",
        "荨麻疹": "皮肤出现风团伴瘙痒的常见过敏反应表现",
        "湿疹": "皮肤慢性炎症性疾病，常表现为红斑、瘙痒、干燥",
        // —— 检验/检查 ——
        "血常规": "对血液中红细胞、白细胞、血小板等主要成分的常规计数检查",
        "尿常规": "对尿液成分的常规检查，包括外观、比重、蛋白、糖等",
        "肝功能检查": "一组反映肝脏代谢与损伤情况的血液检查项目",
        "肾功能检查": "一组反映肾脏滤过功能的血液检查项目",
        "血脂四项": "总胆固醇、甘油三酯、高密度与低密度脂蛋白胆固醇四项",
        "糖化血红蛋白": "反映近两到三个月平均血糖水平的血液指标",
        "电解质": "血液中钠、钾、氯等离子的浓度检查",
        "凝血功能": "评估血液凝固能力的检查项目组",
        "甲状腺功能检查": "评估甲状腺激素水平的血液检查项目组",
        "肿瘤标志物": "提示某些肿瘤可能存在的一类血液检测指标，单项升高不等于确诊",
        "心电图": "记录心脏电活动的检查，简称 ECG",
        "胸部X线": "对胸部器官的X线影像检查，俗称拍胸片",
        "超声检查": "利用超声波成像的无创检查方式",
        "CT": "利用X线断层扫描成像的检查方式",
        "磁共振成像": "利用磁场成像的检查方式，简称 MRI，无电离辐射",
        "白细胞计数": "血常规中白细胞的数量，升高常与感染或炎症相关",
        "血红蛋白": "红细胞内运输氧的蛋白质，用于判断贫血",
        "血小板计数": "血液中血小板的数目，与止血功能相关",
        "C反应蛋白": "炎症时血液中升高的蛋白质，简称 CRP",
    ])
...
/// 审查修复：补「半」类减量表达（减半/半片/吃半粒）——原正则数字类不含「半」，
/// 「帮我减半阿莫西林」绕过 FR12.7 强制拒识并返回普通回答。
public enum HighRiskTopicRules {
    ...
    static let doseChangePatterns = [
        #"吃\s*[0-9一二三四五六七八九十两半]+\s*(mg|片|粒|颗|次|倍)"#,
